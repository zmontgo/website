  ...
  return (
    <>
      <div className='min-h-screen relative'>
        <div className="z-10 relative p-8 flex flex-col justify-between min-h-screen h-full">
        ...
        <Image src={selfie.src} alt='' width={700} height={600} className='absolute lg:right-0 top-0 h-full w-full object-cover lg:object-contain object-left lg:object-right z-0 opacity-10' priority />
      </div>
